...
import 'package:mexoraapp/presentaion/product_detail/pages/product_details_screen.dart';
          ...
          if (state is ProductNameSelectedState) {
            ...
            if (state.item['isFavorite']) {
              context.read<HomeBloc>().add(
                StoreInSharePreferencesEvent(item: state.item),
              );
              showTopSnackBar(
                Overlay.of(context),
                onTap: () {},
                CustomSnackBar.success(
                  message: '${state.item['name']} Added to Favorites',
